...
class WidgetTemplate extends React.Component{
    ...
    handleDeleteButton = (event) =>{
        event.preventDefault();
        console.log("I have id" + this.state.idDeezer + ",trying deletion");
        this.props.handleDelete(this.state.idDeezer);
    }
...
/*
const response = fetch("/home/sauv/deezer?dataDeezer=" + this.state.artistData);
                        ...
                        if (result === '') {
                            ...
                            this.setState({
                                artistData: JSON.stringify(result)
                            });
